...
## [2.0.0] - 2025-12-12
- **Next JS front-end**: Transitioned from a vanilla JS frontend to a proper Next JS UI
  - Simplified UI combining history and updates into the main Containers view
  - Separated out the Security and Graph features into internal plugins, managed through the Integrations tab
- **NPM Integration**: Connect to one or more NPM installations and see which containers are exposed through NPM
